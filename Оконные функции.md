...
**EXCLUDE NO OTHERS**
```
Это вариант по умолчанию, когда ничего не исключается. Если явно не указать условие исключения, будет применен именно этот режим.
...
**EXCLUDE GROUP**
```
При использовании данного условия из фрейма исключается текущая запись, а также все записи, равные ей по значениям столбцов, указанных в ORDER BY.
Name   |Salary|avg    |
-------+------+-------+
Jose   |  8500|13107.1|
...
**EXCLUDE TIES**
```
Позволяет оставить текущую запись в фрейме, но исключить из него все записи, равные текущей по значениям в столбцах ORDER BY.
Name   |Salary|avg    |
-------+------+-------+
Jose   |  8500|12800.0|
Angela | 10000|13000.0|
